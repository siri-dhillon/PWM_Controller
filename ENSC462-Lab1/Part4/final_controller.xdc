...
set_property IOSTANDARD LVCMOS25 [get_ports select_type]
...
set_property PACKAGE_PIN H17 [get_ports {select_type[0]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {select_type[1]}];  # "SW7"